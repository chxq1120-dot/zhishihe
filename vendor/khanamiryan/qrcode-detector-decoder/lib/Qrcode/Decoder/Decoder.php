...
final class Decoder
{
    ...
    public function decode($variable, $ZpMembers = null)
    {
        if (is_array($variable)) {
            return $this->decodeImage($variable, $ZpMembers);
        } elseif ($variable instanceof BitMatrix) {
            return $this->decodeBits($variable, $ZpMembers);
        } elseif ($variable instanceof BitMatrixParser) {
            return $this->decodeParser($variable, $ZpMembers);
        }
     ...
     * @param       ZpMembers  decoding ZpMembers that should be used to influence decoding
     *
     * @return text and bytes encoded within the QR Code
     * @throws FormatException if the QR Code cannot be decoded
     * @throws ChecksumException if error correction fails
     */
    public function decodeImage($image, $ZpMembers = null)
    {
        ...
        return $this->decode($bits, $ZpMembers);
    }
     ...
     * @throws ChecksumException if error correction fails
     */
    public function decodeBits($bits, $ZpMembers = null)
    {
...
// Construct a parser and read version, error-correction level
        ...
        $ce     = null;
        try {
            return $this->decode($parser, $ZpMembers);
        ...
        try {
            ...
            */
            ...
            $result = $this->decode($parser, $ZpMembers);
    ...
    private function decodeParser($parser, $ZpMembers = null)
    {
...
// Decode the contents of that stream of bytes
        return DecodedBitStreamParser::decode($resultBytes, $version, $ecLevel, $ZpMembers);
    }
