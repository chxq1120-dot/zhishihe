...
class FinderPatternFinder
{
    ...
    final public function find($ZpMembers)
    {/*final FinderPatternInfo find(Map<DecodeHintType,?> ZpMembers) throws NotFoundException {*/
        $tryHarder = true;//$ZpMembers != null && $ZpMembers['TRY_HARDER'];
        $pureBarcode = $ZpMembers != null && $ZpMembers['PURE_BARCODE'];
