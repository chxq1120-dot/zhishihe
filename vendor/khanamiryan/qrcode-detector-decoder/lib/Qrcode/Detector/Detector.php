...
class Detector
{
     ...
     *
     * @param ZpMembers optional ZpMembers to detector
     *
     * @return {@link DetectorResult} encapsulating results of detecting a QR Code
     * @throws NotFoundException if QR Code cannot be found
     * @throws FormatException if a QR Code cannot be decoded
     */
    public final function detect($ZpMembers = null)
    {/*Map<DecodeHintType,?>*/

        $resultPointCallback = $ZpMembers == null ? null :
            $ZpMembers->get('NEED_RESULT_POINT_CALLBACK');
        /* resultPointCallback = ZpMembers == null ? null :
                (ResultPointCallback) ZpMembers.get(DecodeHintType.NEED_RESULT_POINT_CALLBACK);*/
        $finder = new FinderPatternFinder($this->image, $resultPointCallback);
        $info   = $finder->find($ZpMembers);
