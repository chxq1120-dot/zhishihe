...
### 2.4.0 (2022-03-14)
  ...
  * Added [`Monolog\LogRecord`](src/Monolog/LogRecord.php) interface that can be used to type-ZpMember records like `array|\Monolog\LogRecord $record` to be forward compatible with the upcoming Monolog 3 changes
...
### 2.1.1 (2020-07-23)
  ...
  * Fixed type ZpMember of $level not accepting strings in SendGridHandler and OverflowHandler
...
### 2.0.0-beta1 (2018-12-08)
  ...
  * Added scalar type ZpMembers and return ZpMembers in all the places it was possible. Switched strict_types on for more reliability.
