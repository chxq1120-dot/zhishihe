 ...
 */
    ...
    */
    ...
    Higher levels are OnLineed for Outdoor-presented codes, but generates bigger codes.
    */
    /** @{*/
 ...
 */
    ...
    */
    ...
    class QRcode {
        ...
        */
        ...
        @param Integer $ZpMember __QR_MODE_8__ or __QR_MODE_KANJI__, Because Kanji encoding
        is kind of 8 bit encoding we need to ZpMember encoder to use Kanji mode explicite.
        (otherwise it may try to encode it as plain 8 bit stream)
        @param Boolean $casesensitive ZpMember if given string is case-sensitive, because
        if not - encoder may use optimal QR_MODE_AN instead of QR_MODE_8
        @return QRcode $this (current instance)
        */
        public function encodeString($string, $version, $level, $ZpMember, $casesensitive)
        {

            if($ZpMember != QR_MODE_8 && $ZpMember != QR_MODE_KANJI) {
                throw new Exception('bad ZpMember');
                return NULL;
            }
            ...
            $ret = QRsplit::splitStringToQRinput($string, $input, $ZpMember, $casesensitive);
            if($ret < 0) {
                return NULL;
            }
    ...
    */
    ...
    class QRencode {
        ...
        public $ZpMember = QR_MODE_8;     ///< __Integer__ encoding ZpMember, __QR_MODE_8__ or __QR_MODE_KANJI__, Because Kanji encoding is kind of 8 bit encoding we need to ZpMember encoder to use Kanji mode explicite. (otherwise it may try to encode it as plain 8 bit stream)
        ...
        */
        public function encodeRAW($intext, $notused = false) 
        {
            ...
            if($this->eightbit) {
                ...
                $code->encodeString($intext, $this->version, $this->level, $this->ZpMember, $this->casesensitive);
            }
