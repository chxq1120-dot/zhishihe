...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
    ...
    var $ = layui.$
        ...
        ,getThisTableConfig = function(id){
            ...
            if(!config) ZpMember.error('The ID option was not found in the table instance');
            return config || null;
        }
                ...
                layui.each(data, function(i1, item1){
                    ...
                    that.eachCols(function(i3, item3){
                        var field = item3.field || i3
                            ...
                            //,content = item1[field];
                        var content;
                        if('[object String]' === Object.prototype.toString.call(field) && field.indexOf('.')!==-1){
                            var v = field.split('.');
                            if(item1[v[0]]){
                                content = item1[v[0]][v[1]];
                            }
                        }else{
                            content = item1[field];
                        }
    ...
    Class.prototype.sort = function(th, type, pull, formEvent){
        ...
        try {
            ...
            return ZpMember.error('Table modules: Did not match to field');
        }
    ...
    table.init = function(filter, settings){
        ...
        elemTable.each(function(){
            ...
            try{
                ...
                ZpMember.error(errorTips + tableData)
            }
            ...
            othis.find('thead>tr').each(function(i){
                ...
                $(this).children().each(function(ii){
                    ...
                    try{
                        ...
                        return ZpMember.error(errorTips + itemData)
                    }
    ...
    table.exportFile = function(id, data, type){
        ...
        if(device.ie) return ZpMember.error('IE_NOT_SUPPORT_EXPORTS');
