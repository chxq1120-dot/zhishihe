...
;(function($, window, document,undefined) {
    ...
    function getPictrue(data,baseUrl,resolve,reject){
		$.ajax({
			...
			url : baseUrl + "/api/index/ajcaptcha",
	...
	function checkPictrue(data,baseUrl,resolve,reject){
		$.ajax({
			type : "post",
			contentType: "application/json;charset=UTF-8",
			url : baseUrl + "/api/index/checkcaptcha",
			data :JSON.stringify(data),
			cache: false,
     		crossDomain: true == !(document.all),
			success:function(res){
        ...
        refresh: function() {
			...
			getPictrue({captchaType:"blockPuzzle", clientUid: localStorage.getItem('slider'), ts: Date.now()},this.options.baseUrl,function (res) {
				if (res.code===200) {
					...
					_this.$element.find(".backImg")[0].src = _this.defaults.baseUrl+'/static/default/img/default.jpg'
        ...
        refresh: function() {
			...
			getPictrue({captchaType:"clickWord", clientUid: localStorage.getItem('point'), ts: Date.now()},_this.options.baseUrl,function(res){
				if (res.code===200) {
					...
					_this.htmlDoms.back_img[0].src = _this.defaults.baseUrl+'/static/default/img/default.jpg';
